...
export function StreamingLinks({ artist, title }: StreamingLinksProps) {
  const links = getStreamingLinks(artist, title);
  ...
  return (
    <div className="flex gap-3">
      <a
        ...
        className="text-text-muted hover:text-[#1DB954] transition-colors"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-text-muted hover:text-[#FA243C] transition-colors"
